...
class TurtleClient(Node):
    def __init__(self):
        ...
        #### Create Parameters (Color) ####
        self.declare_parameter('turtleColor', 'yellow', ParameterDescriptor(description= 'Color of the turtle'))
        turtleColor = self.get_parameter('turtleColor').get_parameter_value().string_value
        self.turtle_display.color(turtleColor)
        
        #### Declare Parameters (pen size) ####
        self.declare_parameter('penSize', 10, ParameterDescriptor(description='Pen thickness of the turtle'))
        ...
        self.server_future = self.color_cli.call_async(self.color_req)
