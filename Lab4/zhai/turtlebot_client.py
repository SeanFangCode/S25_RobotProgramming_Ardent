...
class TurtleClient(Node):
	...
	#### setting the turtle color to blue as default ####
        self.declare_parameter('turtleColor', 'blue', ParameterDescriptor(description="Color of the turtle"))
        turtleColor = self.get_parameter('turtleColor').get_parameter_value().string_value
        self.turtle_display.color(turtleColor)
        
        self.declare_parameter('penSize', 10, ParameterDescriptor(description="Size of the Pen"))
