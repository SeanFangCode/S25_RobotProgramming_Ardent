...
class TurtleClient(Node):
    def __init__(self):
        ...
        #### Color setting ####
        self.declare_parameter('turtleColor', 'yellow', ParameterDescriptor(description="Set turtle color"))
        self.declare_parameter('penSize', 6, ParameterDescriptor(description="Pen size"))
