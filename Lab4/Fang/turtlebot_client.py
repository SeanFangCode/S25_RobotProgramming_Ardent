...
class TurtleClient(Node):
    def __init__(self):
        ...
        ### parameter ###
        self.declare_parameter('turtleColor', 'blue', ParameterDescriptor(description='InitialColor'))
        turtleColor = self.get_parameter('turtleColor').get_parameter_value().string_value
        self.turtle_display.color(turtleColor)
    
    
        self.declare_parameter('penSize', 2,  ParameterDescriptor(description='Pen thickness of the turtle'))
